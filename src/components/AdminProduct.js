...
const AdminProduct = ({product}) => {
    ...
    <div class="md:w-1/3 xl:w-80 p-6 flex flex-col ">
            ...
            <div class="pt-3 flex items-center justify-between">
                <button className="transition ease-in-out duration-300 px-3 py-2 bg-gray-800 text-white border-2 border-gray-800 hover:bg-white hover:text-gray-800" onClick={() => window.location = "/admin/products/aanpassen/" + product.id}> Aanpassen </button>
