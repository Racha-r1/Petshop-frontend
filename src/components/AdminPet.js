...
const AdminPet = ({pet}) => {
    ...
    <div class="w-80 flex items-center">
            ...
            <div class="flex items-center">
                <button className="transition ease-in-out duration-300 px-3 py-2 mr-5 bg-gray-800 text-white border-2 border-gray-800 hover:bg-white hover:text-gray-800" onClick={() => window.location = "/admin/pets/aanpassen/" + pet.id}> Aanpassen </button>
