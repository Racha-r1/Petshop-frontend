...
const ProductDetails = ({setCart}) => {
    ...
    return (
        <div className="lg:w-11/12 sm:w-full mx-auto flex flex-col py-12 px-4">
            {
                product &&  <>
                                <div className="flex flex-wrap w-full">
                                    ...
                                    <div className="flex flex-col lg:justify-around sm:my-8">
                                        ...
                                        <div>
                                            <p className="text-xl">{`€ ${parseFloat(product.price).toFixed(2)}`}</p>
                                            <div className="flex flex-wrap items-center mt-2">
                                                <input className="mr-2 p-3 border-2 border:gray-800" type="number" id="quantity" name="quantity" min="1" onChange={onChangeListener} value={quantity}/>
                                ...
                                <div className="pt-5">
                                    <h1 className="text-2xl font-bold">Beschrijving</h1>
