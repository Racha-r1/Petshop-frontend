...
const FavCategorieën = () => {
    return (
        <div className="lg:w-11/12 m-auto lg:mt-10 mx-auto" >
            <div className="px-3 py-8">
                <h1 className="lg:text-3xl md:text-2xl sm:text-xl font-bold">Favoriete categorieën</h1>
                <br/>
                <div className="flex flex-wrap lg:gap-5 w-full sm:gap-1">
                    <div className="lg:w-96 rounded-lg xsm:w-full sm:w-5/12 xsm:my-4" style={{ backgroundColor: `rgba(218,201,164,0.2)` }} >
                        <img
